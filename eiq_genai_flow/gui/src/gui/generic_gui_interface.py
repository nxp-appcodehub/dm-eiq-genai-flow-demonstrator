...
class GenericGuiInterface(threading.Thread):
    def __init__(self, callback=None, user_config=GuiConfig):
        ...
        try:
            ...
            self.mq_to_gui = posix_ipc.MessageQueue(self.user_config.llmp_to_gui_queue_path, write=True, read=True)
        ...
        try:
            ...
            # If the queue already exists, open it with read and write access
            self.mq_from_gui = posix_ipc.MessageQueue(self.user_config.gui_to_llmp_queue_path, write=True, read=True)
