...
| `▶ Intent detected`      | Command or intent recognized                                 |
...
│ (VIT, ASR, RAG, LLM, TTS) │   posix_ipc Queue   │  (PyQt6 mock client)  │
└───────────────────────────┘                     └───────────────────────┘
```
...
Copyright 2025 NXP. This software is proprietary and subject to LA_OPT_Online Code Hosting NXP_Software_License - v1.4 May 2025
