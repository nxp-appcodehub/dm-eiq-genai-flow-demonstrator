...
screen_text_dict = {
    1: ['Here is the navigation system.', 'Where would you like to go?', 'Please choose a destination.',
    ...
    21: ['Would you like some podcasts?', 'What is your favorite station?', 'Select your radio station.', ],  # Radio
    22: ['Would you like to watch something?', 'Do you want to watch a series?', 'Please select your video.', ],  # Video
    23: ['You want to play a game?', 'Here are your games.', 'Please select your game.', ],  # Games
    ...
    # Energy Consumption
    32: ['Here is your tire interface.', 'Your can monitor the tire pressure here.', 'Tire interface.',
         'Tire pressure.'],  # Tire Pressure
    33: ['Here is your lights and doors screen.', 'Manage your lights, doors, and wipers here.',
         'Lights, doors, and wipers.',
         'You can manage lights, doors, and wipers here.'],  # Lights and doors
    30: ['You can change your drive mode here.', 'Which drive mode would you like?',
         'Please choose your driving mode.'],  # Drive mode
